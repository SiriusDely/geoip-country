...
if (typeof global.geodatadir === 'undefined'){
	...
	*/
	...
	// geodatadir = path.join(appDir, '/../../../node_modules/geoip-country/data/');
	// geodatadir = path.join(process.cwd(), '/../../node_modules/geoip-country/data/');
	geodatadir = path.join(__dirname, '/../../../node_modules/geoip-country/data/');
} else {
