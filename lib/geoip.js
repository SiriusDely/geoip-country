...
if (typeof global.geodatadir === 'undefined'){
	...
	// geodatadir = path.join(__dirname, '/../data/'); // original
	// geodatadir = path.join(process.cwd(), '/node_modules/geoip-country/data/'); // deployed
	// geodatadir = path.join(process.cwd(), '/../../node_modules/geoip-country/data/'); // local
	geodatadir = path.join(__dirname, '/../../../node_modules/geoip-country/data/'); // deployed
	// geodatadir = path.join(appDir, '/../../../node_modules/geoip-country/data/'); // local
} else {
